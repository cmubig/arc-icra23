...
<div class="container" style="margin-top:30px;margin-bottom:30px;">
    ...
    <p style="margin:0 0 20px 0;font-size:14px;color:#000000;"><b>Challenge Oral</b> [<a href="{{ site.baseurl }}/assets/papers/paper_3.pdf" target="_blank">Paper</a>] [<a href="https://youtu.be/bTBk8MFdIOA" target="_blank">Video</a>]</p>
</div>
...
<div class="container" style="margin-top:30px;margin-bottom:30px;">
    ...
    <p style="margin:0 0 20px 0;font-size:14px;color:#000000;"><b>Challenge Oral</b> [<a href="{{ site.baseurl }}/assets/papers/paper_8.pdf" target="_blank">Paper</a>] [<a href="https://youtu.be/5oYUBg9SZEk" target="_blank">Video</a>]</p>
</div>
